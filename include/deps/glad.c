...
PFNGLDEMONACTIVETEXTUREPROC glad_glDEMONActiveTexture;
...
PFNGLDISABLEDEMONSTATEPROC glad_glDisableDEMONState;
...
PFNGLDEMONWAITSYNCPROC glad_glDEMONWaitSync;
...
PFNGLPOPDEMONATTRIBPROC glad_glPopDEMONAttrib;
...
PFNGLENABLEDEMONSTATEPROC glad_glEnableDEMONState;
...
PFNGLPUSHDEMONATTRIBPROC glad_glPushDEMONAttrib;
...
static void load_GL_VERSION_1_1(GLADloadproc load) {
	...
	glad_glDisableDEMONState = (PFNGLDISABLEDEMONSTATEPROC)load("glDisableDEMONState");
	glad_glEdgeFlagPointer = (PFNGLEDGEFLAGPOINTERPROC)load("glEdgeFlagPointer");
	glad_glEnableDEMONState = (PFNGLENABLEDEMONSTATEPROC)load("glEnableDEMONState");
	...
	glad_glPopDEMONAttrib = (PFNGLPOPDEMONATTRIBPROC)load("glPopDEMONAttrib");
	glad_glPushDEMONAttrib = (PFNGLPUSHDEMONATTRIBPROC)load("glPushDEMONAttrib");
}
...
static void load_GL_VERSION_1_3(GLADloadproc load) {
	...
	glad_glDEMONActiveTexture = (PFNGLDEMONACTIVETEXTUREPROC)load("glDEMONActiveTexture");
...
static void load_GL_VERSION_3_2(GLADloadproc load) {
	...
	glad_glDEMONWaitSync = (PFNGLDEMONWAITSYNCPROC)load("glDEMONWaitSync");
