...
void zbuffer_init()
{
	...
	pshader = new Shader(FileSystem::getPath("shader/depth_testing.vs").c_str(), FileSystem::getPath("shader/depth_testing.fs").c_str());
	...
	//cubeTexture = loadTexture("res/marble.jpg");
	//floorTexture = loadTexture("res/metal.png");
...
void zbuffer_loop(GLFWwindow* window)
{
